      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <Card className="border-0 shadow-sm">
          <CardContent className="py-3 px-4">
            ...
            <p className="text-lg font-bold text-green-600 mt-1">{formatCurrency(totalReceitas)}</p>
          </CardContent>
        </Card>
        <Card className="border-0 shadow-sm">
          <CardContent className="py-3 px-4">
            ...
            <p className="text-lg font-bold text-red-600 mt-1">{formatCurrency(totalDespesas)}</p>
          </CardContent>
        </Card>
        <Card className="border-0 shadow-sm col-span-2 sm:col-span-1">
          <CardContent className="py-3 px-4">
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-500">Saldo filtrado</span>
            </div>
            <p className={`text-lg font-bold mt-1 ${totalReceitas - totalDespesas >= 0 ? 'text-blue-600' : 'text-orange-600'}`}>
        ...
        <CardContent className="p-0">
          {filtered.length === 0 ? (
            ...
            <div className="divide-y divide-slate-50">
              {filtered.map(t => (
                <div key={t.id} className="flex items-center justify-between px-4 py-3 hover:bg-slate-50 transition-colors group">
