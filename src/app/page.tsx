...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-slate-100 sticky top-0 bg-white/80 backdrop-blur-sm z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login">
              <Button variant="ghost" size="sm" className="text-slate-600">Entrar</Button>
            </Link>
            <Link href="/cadastro">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-20 sm:py-28">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-slate-800">Tudo que você precisa</h2>
            <p className="text-slate-500 mt-3 text-lg">Ferramentas simples e poderosas para organizar suas finanças</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="p-6 rounded-2xl border border-slate-100 hover:border-blue-100 hover:shadow-md transition-all group">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl font-bold text-slate-800 mb-3">9 categorias pré-definidas</h2>
          <p className="text-slate-500 mb-8">Organize suas transações de forma inteligente</p>
      ...
      <footer className="border-t border-slate-100 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-700 text-sm">FinançasPessoais</span>
          </div>
